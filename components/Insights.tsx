export default function Insights() {
  ...
  return (
    <section id="insights" className="py-24 bg-steel-950">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-display font-bold mb-4">
            <span className="text-steel-50">Insights &</span>{' '}
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="p-8 rounded-xl bg-gradient-to-br from-accent-blue/10 to-accent-cyan/10 border border-accent-blue/20 h-full">
              <div className="flex items-start space-x-4 mb-6">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-steel-50 mb-2">
                    [Podcast Name]
                  </h3>
          ...
          <div className="p-8 rounded-xl bg-steel-900/50 border border-steel-800/50">
            <h3 className="text-2xl font-bold text-steel-50 mb-6">Awards & Recognition</h3>
            <div className="space-y-6">
              {awards.map((award, index) => (
                <div key={index} className="pb-6 border-b border-steel-800/50 last:border-0 last:pb-0">
                  <div className="flex items-start space-x-3 mb-2">
                    ...
                    <div>
                      <h4 className="font-semibold text-steel-200">{award.title}</h4>
                      <p className="text-sm text-steel-400">{award.organization}</p>
        ...
        <div className="mt-8">
          <h3 className="text-2xl font-bold text-steel-50 mb-6">Published Articles</h3>
          <div className="grid md:grid-cols-3 gap-6">
            {articles.map((article, index) => (
              <a
                key={index}
                href={article.link}
                className="group p-6 rounded-xl bg-steel-900/30 border border-steel-800/50 hover:border-accent-blue/30 transition-all duration-300 hover:-translate-y-1"
              >
                ...
                <h4 className="font-semibold text-steel-200 mb-2 group-hover:text-accent-blue transition-colors">
                  {article.title}
                </h4>
                <p className="text-sm text-steel-500">{article.date}</p>
              </a>
            ))}
          </div>
        </div>
