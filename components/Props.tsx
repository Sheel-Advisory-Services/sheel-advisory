  ...
  return (
    ...
    >
      <div className="container mx-auto px-6">
        ...
        {/* Podcast Feature — re-enable by setting SHOW_PODCAST = true above */}
        {SHOW_PODCAST && (
          <div className="mt-8 p-4 md:p-8 rounded-xl bg-gradient-to-br from-accent-blue/10 to-accent-cyan/10 border border-accent-blue/30 dark:border-accent-blue/20">
