...
export const metadata = {
  title: "School Districts | Sheel Advisory Services",
  description: "Owner representative services for school districts across British Columbia.",
};
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-steel-600 dark:text-steel-300 leading-relaxed">
              Educational facility planning and construction oversight with focus on community impact.
            </p>
          </div>
        </div>
      </section>
              ...
              <div>
                ...
                <div className="prose prose-lg dark:prose-invert">
                  <p className="text-steel-600 dark:text-steel-300 leading-relaxed mb-4">
                    [Detailed description of services for school districts - to be added]
                  </p>
              ...
              <div className="mt-12 p-8 rounded-xl bg-gradient-to-r from-accent-blue/10 to-accent-cyan/10 border border-accent-blue/30">
                <div className="text-center">
                  ...
                  <p className="text-steel-600 dark:text-steel-300 mb-6">
                    Let's discuss how we can support your school district's goals.
                  </p>
                  <Link
                    href="/#contact"
