...
export const metadata = {
  title: "Non-Profit Organizations | Sheel Advisory Services",
  description: "Owner representative services for non-profit organizations across British Columbia.",
};
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-steel-600 dark:text-steel-300 leading-relaxed">
              Cost-effective project delivery and risk management tailored to mission-driven budgets.
            </p>
          </div>
        </div>
      </section>
              ...
              <div>
                ...
                <div className="prose prose-lg dark:prose-invert">
                  <p className="text-steel-600 dark:text-steel-300 leading-relaxed mb-4">
                    [Detailed description of services for non-profits - to be added]
                  </p>
