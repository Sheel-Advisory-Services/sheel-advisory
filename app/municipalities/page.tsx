...
export const metadata = {
  title: "Municipalities | Sheel Advisory Services",
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-steel-600 dark:text-steel-300 leading-relaxed">
              Comprehensive project management and risk assessment for urban development and infrastructure projects.
            </p>
          </div>
        </div>
      </section>
              ...
              <div>
                ...
                <div className="prose prose-lg dark:prose-invert">
                  <p className="text-steel-600 dark:text-steel-300 leading-relaxed mb-4">
                    [Detailed description of services for municipalities - to be added]
                  </p>
